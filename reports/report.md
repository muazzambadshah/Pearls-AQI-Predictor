...
**Generated:** 2026-09-15 08:21 UTC
...
with **R² = 0.618**, which is a **29.7% reduction in RMSE against a persistence forecast**. Accuracy is
...
The model is trained on **32,481 hours** of real observations
(1353 days, 2023-01-01 to 2026-09-15) pulled from
...
| Rows | 32,481 hourly observations |
| Span | 2023-01-01 00:00 → 2026-09-15 08:00 (1353 days) |
| Missing hours | 0 |
...
| Range | 56 – 538 |
| 95th percentile | 236 |
| Hours ≥ 150 (Unhealthy) | 17,481 (53.8%) |
...
| First difference | -19.53 | 0.0000 | yes |
...
|---|---|---|---|---|---|---|---|
| blend_top2 | 27.61 | 7.16 | 18.70 | 0.618 | 0.297 | 0.654 | 4 |
| blend_top4 | 27.65 | 7.31 | 18.62 | 0.617 | 0.297 | 0.655 | 4 |
| blend_top3 | 27.75 | 7.56 | 18.63 | 0.612 | 0.295 | 0.658 | 4 |
| lightgbm | 28.46 | 6.89 | 19.43 | 0.599 | 0.274 | 0.641 | 4 |
| lightgbm_anchored | 28.75 | 8.44 | 18.90 | 0.582 | 0.272 | 0.658 | 4 |
| hist_gradient_boosting_anchored | 28.94 | 8.56 | 19.05 | 0.576 | 0.268 | 0.659 | 4 |
| random_forest | 28.95 | 6.86 | 19.56 | 0.587 | 0.260 | 0.638 | 4 |
| hist_gradient_boosting | 29.05 | 7.11 | 19.73 | 0.583 | 0.259 | 0.640 | 4 |
| ridge | 29.57 | 7.90 | 21.15 | 0.549 | 0.248 | 0.624 | 4 |
| ridge_anchored | 29.57 | 7.90 | 21.15 | 0.549 | 0.248 | 0.624 | 4 |
| extra_trees_anchored | 29.84 | 8.17 | 19.61 | 0.554 | 0.242 | 0.646 | 4 |
| elastic_net | 30.30 | 7.30 | 21.37 | 0.536 | 0.227 | 0.616 | 4 |
| baseline:persistence | 39.11 | 8.95 | 26.42 | 0.234 | — | 0.570 | 4 |
| baseline:climatology | 39.19 | 6.45 | 29.55 | 0.274 | — | 0.466 | 4 |
| baseline:seasonal_naive_24h | 40.21 | 8.84 | 27.32 | 0.211 | — | 0.548 | 4 |
...
`lightgbm` at 28.46 — it beats the best single model by 0.85 RMSE. A blend is
...
|---|---|---|---|
| `hist_gradient_boosting` | 29.05 | 28.94 | +0.11 |
| `lightgbm` | 28.46 | 28.75 | -0.29 |
| `ridge` | 29.57 | 29.57 | -0.00 |
...
|---|---|---|---|---|---|
| Day 1 (1–24h) | 21.03 | 13.94 | 0.811 | 73.1% | +15.6% |
| Day 2 (25–48h) | 29.86 | 19.92 | 0.626 | 63.1% | +28.4% |
| Day 3 (49–72h) | 32.53 | 22.25 | 0.558 | 59.8% | +30.8% |
...
| Feature | Mean \|SHAP\| |
|---|---|
| tgt_wind_speed_10m_rollmean_24h | 5.163 |
| pm2_5_rollmean_24h | 3.935 |
| tgt_hour_sin | 2.842 |
| tgt_doy_cos | 2.216 |
| tgt_month_cos | 2.081 |
| tgt_relative_humidity_2m_rollmean_24h | 1.933 |
| tgt_temperature_2m_rollmean_24h | 1.821 |
| tgt_temperature_2m_rollmean_6h | 1.808 |
| pm2_5_at_origin | 1.649 |
| aqi_rollmean_168h | 1.215 |
| tgt_hour | 1.118 |
| ozone_rollmean_24h | 1.085 |
